from Modbus.common  import Request
from Modbus.common  import ModbusException
from machine        import UART
from machine        import Pin
import Modbus.functions as functions
import Modbus.const     as Const
import machine
import struct
import time
...
class ModbusSerial:
    def __init__(self, uart_id, baudrate=19200, data_bits=8, stop_bits=1, parity=None, ctrl_pin=None):
        self._uart = UART(uart_id, baudrate=baudrate, bits=data_bits, parity=parity, stop=stop_bits )
