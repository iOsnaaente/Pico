...
ALGUNS MÓDULOS NUMPY UTILIZADOS PARA FAZER A APROXIMAÇÃO LINEAR DE FUNÇÕES 
APARTIR DE PONTOS DEFINIDOS. 
COMO O RASPBERRY PI PICO NÃO PERMITE O USO DE NUMPY, DEVIDO O TAMANHO
ESSA BIBLIOTECA SUBSTITUI ALGUNS DOS MÓDULOS MAIS ÚTEIS.

POR FAVOR, AJUDE A TORNAR ESSA LISTA DE MÓDULOS MAIOR ;)
'''
