#####   ESCRITO POR:        Bruno Gabriel Flores Sampaio
#####   E-MAIL:             bruno.sampaio@acad.ufsm.br
#
#####   NOME:               myNumpy.py
#
#####   VERSÃO:             1.0
#
#####   DESCRIÇÃO:          Possibilita a utilização de funções aritméticas importantes
#                           que são encontradas no módulo Numpy. Como o RP2040 não suporta 
#                           Numpy, foram replicados as principais funções necessárias para 
#                           a utilização dos métodos numéricos para aproximação linear de 
#                           funções.
# 
#####   DATA DA CRIAÇÃO:    23/05/2021
#####   DISTRO:             Raspberry pi Pico - Micropython 
#####   LICENÇA:            MIT
#####   PROJETO:            https://github.com/iOsnaaente/Pico/myNumpy/myNumpy.git
