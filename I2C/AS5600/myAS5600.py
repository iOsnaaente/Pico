...
i2c = machine.I2C( 1, freq = 1_000_000, scl = machine.Pin( 3 ), sda = machine.Pin( 2 )  )
as5600 = AS5600( i2c, 54 )

while True:
    if as5600.checkStatus() == 0:
        read = as5600.readAngle()
        read = struct.pack( 'f', read ) 
